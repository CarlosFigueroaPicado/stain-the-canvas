...
create index if not exists idx_productos_video_url on public.productos (video_url) where video_url is not null;
...
-- Safe migration: keeps legacy categoria text and gallery_urls for compatibility.
-- ============================================================================
